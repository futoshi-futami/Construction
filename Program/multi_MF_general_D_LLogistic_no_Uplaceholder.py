...
def _each_loss(X,Y,Num,Model_prior,D,F,U):
    ...
    Posteri_numerator=Log_likelihood[:,None]+Prior+minus_Log_det_J[:,None]
...
Ws=[minus_inf_inf_to_zero_one(__w) for __w in _w_s]
...
if True:    
	...
	for i in range(2000): # train the model n_epochs times
		print(i)
		for _ in range(1):
